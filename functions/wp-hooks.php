<?php
    ...
    add_action('wp_footer', 'fwp_display_term', 100); // Displaying search term on search page
    add_filter( 'facetwp_preload_url_vars', 'preselect_board' ); // Preselecting "board members" on page load
